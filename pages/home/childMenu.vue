<template>
  <view>
    <view class="nav-set">
      ...
      <uni-view class="nav-set-right">
        <uni-text class="cuIcon-notice icon-notice"></uni-text>
        <uni-text @click="actionSheet" class="cuIcon-settingsfill icon-setting"></uni-text
      ></uni-view>
    </view>
  ...
  data() {
    return {
      ...
      },
      {
        ...
        name: 'cuIcon-emoji',
        color: '#9c26b0',
        path: '/pages/unusualToMake/index'
      },
      {
        title: '转料',
        name: 'cuIcon-emoji',
        color: '#e03997',
        path: '/pages/shiftMatter/index'
      },
      {
        title: '补打条码',
        name: 'cuIcon-emoji',
        color: '#a5673f',
        path: '/pages/printBarCode/index'
      },
